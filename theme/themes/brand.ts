...
export const brand = {
  'light': vars({
    ...
    '--color-background-darkest-a1': Color(slate['8']).alpha(0.9),
    '--color-background-darkest-a2': Color(slate['8']).alpha(0.75),
    '--color-background-darkest-a3': Color(slate['8']).alpha(0.6),
